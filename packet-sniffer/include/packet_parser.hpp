...
class PacketParser {
    /*  
        ...
        Data - dst_bytes: Number of data bytes transferred from destination to source in single connection
    ...
    */
    ...
    public:
        ...
        std::string toJSON(std::string input);
    ...
    private:
        ...
        std::unordered_map<std::string, int> service_count;
