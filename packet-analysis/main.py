...
detector.train(data)
detector.save_model("./packet-analysis/anomaly_detector.pkl")


detector.load_model("./packet-analysis/anomaly_detector.pkl")
...
while True:
    ...
    if raw_packet != '':
        ...
        print(detector.predict(data)) #output can be changed to any location
